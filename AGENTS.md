...
- Treat `docs/architecture.md`, accepted ADRs, public schemas, and tested contracts as product and architecture authority; keep public docs aligned with implemented behavior.
